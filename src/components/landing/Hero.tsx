        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            <dl className="sr-only">
              <dt>Стоимость рассылки в Telegram</dt>
              <dd>от 5 рублей за сообщение</dd>
              <dt>Стоимость рассылки в WhatsApp</dt>
              <dd>от 5 рублей за сообщение</dd>
              <dt>Минимальный заказ рассылки</dt>
              <dd>2500 рублей (500 сообщений)</dd>
              <dt>Цена лида через рассылки</dt>
              <dd>от 50 рублей</dd>
              <dt>Опыт работы RichSMM</dt>
              <dd>8 лет в digital-маркетинге</dd>
              <dt>Количество клиентов</dt>
              <dd>более 500 довольных клиентов</dd>
              <dt>Время до первых заявок</dt>
              <dd>2–6 часов после запуска рассылки</dd>
              <dt>Открываемость сообщений в Telegram</dt>
              <dd>40–80 процентов</dd>
              <dt>Открываемость сообщений в WhatsApp</dt>
              <dd>85–95 процентов</dd>
            </dl>
          </motion.div>

...
const faqs = [
  ...
  },
  {
    ...
    a: "Рассылки обходятся в разы дешевле Яндекс.Директа и таргета ВКонтакте — при сопоставимом или лучшем результате. Стоимость от 1,5₽ за сообщение, без дорогой настройки и специалистов.",
  },
  {

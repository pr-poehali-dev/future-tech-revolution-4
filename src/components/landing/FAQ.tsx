...
const faqs = [
  ...
  },
  {
    ...
    a: "Да. Мы сами соберём целевую базу из тематических Telegram-групп, чатов и открытых источников под вашу нишу. Вам нужно только рассказать, кто ваш клиент.",
  },
  {
    q: "Чем ваши рассылки лучше Яндекс.Директа?",
    a: "Рассылки дешевле в 5–20 раз по цене лида, запускаются за 1 день (не 2–4 недели), дают результат в первые часы. Минимальный бюджет — 2 500 ₽ вместо 30 000+ в Директе.",
  },
  {
  ...
  },
  {
    ...
    a: "Если ваша аудитория до 45 лет — Telegram эффективнее и дешевле. Если аудитория 35–60+ или нужна максимальная доходимость — WhatsApp. Лучший вариант — комбинация обоих каналов.",
  },
]
